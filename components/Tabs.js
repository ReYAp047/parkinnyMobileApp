  ...
  return (
    <NavigationContainer independent={true}>
      <Tab.Navigator screenOptions={{ headerShown: false }}>
        <Tab.Screen name="Map" component={Map} options={{tabBarIcon: () => (<Image source={{uri:'https://res.cloudinary.com/dhncrtnjp/image/upload/v1650120729/map_xjciba.png',}} style={{width: 33, height: 33}} />)}}/>
        ...
        <Tab.Screen name="Reserve" component={Reserve} options={{tabBarIcon: () => (<Image source={{uri:'https://res.cloudinary.com/dhncrtnjp/image/upload/v1650122142/edit_pencil_paper_modify_write_icon_141958_lwwhcb.png',}} style={{width: 40, height: 40}} />)}}/>
